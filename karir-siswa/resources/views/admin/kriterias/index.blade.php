...
@section('content')
    <div style="display: flex; flex-direction: column; gap: 24px;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
            <div>
                <h1 style="margin: 0 0 4px; font-size: 1.6rem; font-weight: 800; letter-spacing: -0.025em; color: #0f172a;">Data Kriteria C4.5</h1>
            ...
            <a href="{{ route('admin.kriterias.create') }}" style="background-color: #0f766e; color: #ffffff; padding: 10px 18px; border-radius: 8px; font-weight: 700; font-size: 0.9rem; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 4px 6px -1px rgba(15, 118, 110, 0.15); transition: all 0.2s;">
            ...
            <div style="padding: 16px 20px; border-bottom: 1px solid #f1f5f9; background: #f8fafc; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
                <form method="GET" action="" style="display: flex; gap: 8px; width: 100%; max-width: 420px; align-items: center; position: relative;">
                    <div style="position: relative; flex: 1;">
                        ...
                        <input name="q" value="{{ $search }}" placeholder="Cari nama kriteria..." style="width: 100%; border: 1px solid #cbd5e1; border-radius: 8px; padding: 8px 12px 8px 36px; font-size: 0.875rem; min-height: 38px; outline: none; box-sizing: border-box;">
                    </div>
                    ...
                    @if($search)
                        <a href="{{ route('admin.kriterias.index') }}" style="color: #64748b; font-size: 0.85rem; font-weight: 600; text-decoration: none; padding-left: 4px;">Reset</a>
                    @endif
                </form>
            </div>
                ...
                <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.9rem; min-width: 700px;">
                    <thead>
                        <tr style="background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                            <th style="padding: 14px 20px; font-weight: 750; color: #475569; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; width: 30%;">Nama Kriteria</th>
                            <th style="padding: 14px 20px; font-weight: 750; color: #475569; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; width: 20%;">Tipe Data</th>
                            <th style="padding: 14px 20px; font-weight: 750; color: #475569; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; width: 35%;">Keterangan</th>
                            ...
                            <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.15s;">
                                ...
                                <td style="padding: 16px 20px; vertical-align: middle;">
                                    @if ($kriteria->tipe_data === \App\Models\Kriteria::TYPE_KATEGORIK)
                                        <span style="background-color: #e0f2fe; color: #0369a1; padding: 4px 10px; border-radius: 20px; font-weight: 750; font-size: 0.75rem; display: inline-flex; align-items: center; gap: 4px;">
                                            <span style="width: 6px; height: 6px; border-radius: 50%; background-color: #0284c7; display: inline-block;"></span>
                                            Kategorik
                                        </span>
                                    @else
                                        <span style="background-color: #f3e8ff; color: #6b21a8; padding: 4px 10px; border-radius: 20px; font-weight: 750; font-size: 0.75rem; display: inline-flex; align-items: center; gap: 4px;">
                                ...
                                <td style="padding: 16px 20px; vertical-align: middle; text-align: right;">
                                    <div style="display: inline-flex; gap: 8px; justify-content: flex-end; align-items: center;">
                                        <a href="{{ route('admin.kriterias.edit', $kriteria) }}" style="background-color: #f1f5f9; border: 1px solid #cbd5e1; color: #334155; padding: 6px 12px; border-radius: 6px; font-weight: 700; font-size: 0.8rem; text-decoration: none; display: inline-flex; align-items: center; gap: 4px; transition: all 0.2s;">
