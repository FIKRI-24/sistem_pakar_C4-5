@extends('layouts.app', ['title' => $soal->exists ? 'Ubah Pertanyaan' : 'Tambah Pertanyaan'])

@section('content')
    <section class="panel" style="max-width:760px;margin:auto"><div class="panel-body"><p class="role-badge">Data Pertanyaan</p><h1>{{ $soal->exists ? 'Ubah Pertanyaan' : 'Tambah Pertanyaan' }}</h1>
