...
@section('content')
    <div style="display: flex; flex-direction: column; gap: 24px;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
            <div>
                <h1 style="margin: 0 0 4px; font-size: 1.6rem; font-weight: 800; letter-spacing: -0.025em; color: #0f172a;">Data Siswa</h1>
                <p style="margin: 0; font-size: 0.95rem; color: #64748b;">Kelola daftar siswa terdaftar yang mengikuti kuesioner minat dan bakat.</p>
            </div>
            <a href="{{ route('admin.siswas.create') }}" style="background-color: #0f766e; color: #ffffff; padding: 10px 18px; border-radius: 8px; font-weight: 700; font-size: 0.9rem; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; box-shadow: 0 4px 6px -1px rgba(15, 118, 110, 0.15); transition: all 0.2s;">
            ...
            <div style="padding: 16px 20px; border-bottom: 1px solid #f1f5f9; background: #f8fafc; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
                <form method="GET" action="" style="display: flex; gap: 8px; width: 100%; max-width: 420px; align-items: center; position: relative;">
                    <div style="position: relative; flex: 1;">
                        ...
                        <input name="q" value="{{ $search }}" placeholder="Cari nama, NIS, kelas, atau jurusan..." style="width: 100%; border: 1px solid #cbd5e1; border-radius: 8px; padding: 8px 12px 8px 36px; font-size: 0.875rem; min-height: 38px; outline: none; box-sizing: border-box;">
                    </div>
                    ...
                    @if($search)
                        <a href="{{ route('admin.siswas.index') }}" style="color: #64748b; font-size: 0.85rem; font-weight: 600; text-decoration: none; padding-left: 4px;">Reset</a>
                    @endif
                </form>
            </div>
                ...
                <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.9rem; min-width: 700px;">
                    <thead>
                        <tr style="background: #f8fafc; border-bottom: 1px solid #e2e8f0;">
                            ...
                            <th style="padding: 14px 20px; font-weight: 750; color: #475569; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; width: 35%;">Nama / Akun</th>
                            <th style="padding: 14px 20px; font-weight: 750; color: #475569; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; width: 15%;">Kelas</th>
                            <th style="padding: 14px 20px; font-weight: 750; color: #475569; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; width: 20%;">Jurusan</th>
                    ...
                    <tbody style="background: #ffffff;">
                        @forelse ($siswas as $siswa)
                            <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.15s;">
                                ...
                                <td style="padding: 16px 20px; vertical-align: top;">
                                    <strong style="font-size: 0.95rem; font-weight: 750; color: #0f172a; display: block; margin-bottom: 2px;">{{ $siswa->user->name }}</strong>
                                    <span style="font-size: 0.8rem; color: #64748b; display: block;">
                                        {{ $siswa->user->username }}{{ $siswa->user->email ? ' · ' . $siswa->user->email : '' }}
                                    </span>
                                </td>
                                ...
                                <td style="padding: 16px 20px; vertical-align: middle; text-align: right;">
                                    <div style="display: inline-flex; gap: 8px; justify-content: flex-end; align-items: center;">
                                        <a href="{{ route('admin.siswas.edit', $siswa) }}" style="background-color: #f1f5f9; border: 1px solid #cbd5e1; color: #334155; padding: 6px 12px; border-radius: 6px; font-weight: 700; font-size: 0.8rem; text-decoration: none; display: inline-flex; align-items: center; gap: 4px; transition: all 0.2s;">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" style="padding: 32px 20px; text-align: center; color: #64748b; font-style: italic;">
