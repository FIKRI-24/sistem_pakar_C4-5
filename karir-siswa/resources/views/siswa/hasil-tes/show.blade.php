@extends('layouts.app', ['title' => 'Hasil Tes Saya'])
...
@section('content')
    ...
    <div style="max-width: 840px; margin: 0 auto; display: flex; flex-direction: column; gap: 24px;">
        ...
        <div>
            <a href="{{ route('siswa.hasil-tes.index') }}" style="display: inline-flex; align-items: center; gap: 6px; color: #64748b; font-size: 0.875rem; font-weight: 700; text-decoration: none; transition: color 0.2s;">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>
                Kembali ke Riwayat Tes Saya
            </a>
        </div>
        ...
        <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.03); overflow: hidden;">
            ...
            <div style="padding: 28px 32px; border-bottom: 1px solid #f1f5f9; background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
                <div>
                    ...
                    <p style="margin: 0; font-size: 0.9rem; color: #64748b; font-weight: 600;">
                        Dikerjakan pada tanggal <strong style="color: #0f172a;">{{ $hasilTes->tanggal_tes->format('d-m-Y H:i') }}</strong>
                    </p>
                </div>

                <div style="display: flex; gap: 10px;">
                    <!-- 3D PDF Button -->
                    <a href="{{ route('siswa.hasil-tes.pdf', $hasilTes) }}" target="_blank" class="btn-3d btn-3d-blue">
            ...
            <div style="padding: 32px; display: flex; flex-direction: column; gap: 28px;">
                @if(session('success'))
                    <div style="background-color: #ecfdf5; border: 1px solid #a7f3d0; color: #047857; padding: 14px 18px; border-radius: 12px; font-weight: 700; font-size: 0.9rem; display: flex; align-items: center; gap: 10px;">
                ...
                <div>
                    <h2 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; margin: 0 0 14px; display: flex; align-items: center; gap: 8px;">
                        ...
                        <span>Ringkasan Nilai Kuesioner Anda</span>
                    </h2>
                        ...
                        <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.9rem;">
                            <thead>
                                <tr style="background: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                                    ...
                                    <th style="padding: 12px 20px; font-weight: 800; color: #475569; font-size: 0.775rem; text-transform: uppercase; letter-spacing: 0.05em; width: 50%;">Nilai Anda</th>
                                </tr>
                            </thead>
                ...
                <div>
                            ...
                            @foreach($hasilTes->rekomendasis as $rekomendasi)
                                <div style="border: none; border-radius: 16px; padding: 24px 28px; background: #edf7f5; box-shadow: 0 4px 16px rgba(13, 148, 136, 0.08);">
                                    ...
                                    <div style="background: #ffffff; border: 1px solid #ccfbf1; border-radius: 12px; padding: 18px 20px; margin-top: 14px;">
                                        ...
                                        <!-- Analisis Penjelasan Karir -->
                                        <div style="border-top: 1px dashed #cbd5e1; padding-top: 12px; font-size: 0.875rem; color: #334155; line-height: 1.6;">
                                            <strong style="color: #0f172a; font-weight: 800; display: block; margin-bottom: 4px;">💡 Mengapa Karir Ini Sangat Cocok Untuk Anda?</strong>
                                            <p style="margin: 0;">
                                                Berdasarkan hasil analisis algoritma C4.5 terhadap minat, bakat, kepribadian, dan nilai akademik yang Anda isi, profil potensi Anda cocok untuk karir <strong>{{ $rekomendasi->karir->nama_karir }}</strong>. Konsultasikan hasil ini dengan Guru BK sekolah untuk bimbingan lebih lanjut!
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @else
                        <div style="border: none; border-radius: 14px; padding: 24px; background: #f8fafc; text-align: center; color: #64748b;">
                            <p style="margin: 0; font-weight: 700; font-size: 0.95rem;">Rekomendasi C4.5 belum tersedia.</p>
                        </div>
                    @endif
                </div>
                ...
                @if($hasilTes->jawabans->isNotEmpty())
                    <div>
                        <h2 style="font-size: 1.15rem; font-weight: 800; color: #0f172a; margin: 0 0 14px; display: flex; align-items: center; gap: 8px;">
                            ...
                            <span>Riwayat Jawaban Kuesioner Anda (Per Butir Soal)</span>
                        </h2>
                            ...
                            <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.875rem;">
                                <thead>
                                    <tr style="background: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                                        ...
                                        <th style="padding: 12px 16px; font-weight: 800; color: #475569; font-size: 0.75rem; text-transform: uppercase; width: 22%;">Jawaban Anda</th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                <div style="display: flex; gap: 12px; padding-top: 16px; border-top: 1px solid #f1f5f9;">
                    <a class="btn-3d btn-3d-secondary" href="{{ route('siswa.hasil-tes.index') }}">Kembali ke Riwayat Hasil</a>
                </div>
            </div>
        </div>
    </div>
